    ...
    return (
        ...
        >
            <Form form={form} initialValues={initValue} layout="vertical">
                ...
                <Form.Item label="门店简介" name="description" rules={[{ required: true }]}>
                    <Input.TextArea
                        maxLength={500}
                        rows={5}
                ...
                <Row className={style.row} gutter={20}>
                    <Col span={8}>
                        <Form.Item
                            ...
                            rules={[{ required: true }]}
                        >
                            <UploadImage label="替换营业执照" maxCount={1} imgCropAspect={3 / 2} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                        <Form.Item
                            ...
                            rules={[{ required: true }]}
                        >
                            <UploadImage label="替换身份证" maxCount={1} imgCropAspect={3 / 2} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                        <Form.Item
